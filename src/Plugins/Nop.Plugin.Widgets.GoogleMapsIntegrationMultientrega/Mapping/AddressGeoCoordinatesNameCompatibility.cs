...
namespace Nop.Plugin.Widgets.GoogleMapsIntegrationMultientrega.Mapping
{
    ...
    public sealed class AddressGeoCoordinatesNameCompatibility : INameCompatibility
    {
        ...
        public Dictionary<(Type, string), string> ColumnName => new Dictionary<(Type, string), string>
        {
            ...
            {(typeof(AddressGeoCoordinatesMapping),  "ProvinceId"), "ProvinceId"},
            {(typeof(AddressGeoCoordinatesMapping),  "DistrictId"), "DistrictId"},
            {(typeof(AddressGeoCoordinatesMapping),  "TownshipId"), "TownshipId"},
            {(typeof(AddressGeoCoordinatesMapping),  "NeighborhoodId"), "NeighborhoodId"}
        };
    }
}