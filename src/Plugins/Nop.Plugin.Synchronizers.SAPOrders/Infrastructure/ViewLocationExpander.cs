...
namespace Nop.Plugin.Synchronizers.SAPOrders.Infrastructure
{
    /// <summary>
    ...
    public sealed class ViewLocationExpander : IViewLocationExpander
    {
        ...
        public IEnumerable<string> ExpandViewLocations(ViewLocationExpanderContext context, IEnumerable<string> viewLocations)
        {
            ...
            {
                viewLocations = new[] { $"/Plugins/Synchronizers.SAPOrders/Areas/Admin/Views/{context.ControllerName}/{context.ViewName}.cshtml" }.Concat(viewLocations);
            }
            else
            {
                viewLocations = new[] { $"/Plugins/Synchronizers.SAPOrders/Views/{context.ControllerName}/{context.ViewName}.cshtml" }.Concat(viewLocations);
            }
