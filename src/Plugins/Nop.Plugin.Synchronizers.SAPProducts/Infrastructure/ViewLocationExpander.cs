...
namespace Nop.Plugin.Synchronizers.SAPProducts.Infrastructure
{
    ...
    public class ViewLocationExpander : IViewLocationExpander
    {
        ...
        public IEnumerable<string> ExpandViewLocations(ViewLocationExpanderContext context, IEnumerable<string> viewLocations)
        {
            ...
            {
                viewLocations = new[] { $"/Plugins/Nop.Plugin.Synchronizers.SAPProducts/Areas/Admin/Views/{context.ControllerName}/{context.ViewName}.cshtml" }.Concat(viewLocations);
            }
            else
            {
                viewLocations = new[] { $"/Plugins/Nop.Plugin.Synchronizers.SAPProducts/Views/{context.ControllerName}/{context.ViewName}.cshtml" }.Concat(viewLocations);
            }
