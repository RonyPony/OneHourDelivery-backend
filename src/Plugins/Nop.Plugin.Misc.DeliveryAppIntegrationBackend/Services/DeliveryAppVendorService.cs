...
namespace Nop.Plugin.Misc.DeliveryAppIntegrationBackend.Services
{
    ...
    public class DeliveryAppVendorService : IVendorDeliveryAppService
    {
        ...
        private readonly IRepository<WarehouseScheduleMapping> _warehouseScheduleMappingRepository;
        ...
        public DeliveryAppVendorService(
            ...
            IRepository<WarehouseScheduleMapping> warehouseScheduleMappingRepository,
            ...
            IRepository<ProductPicture> productPictureRepository)
        {
            ...
            _warehouseScheduleMappingRepository = warehouseScheduleMappingRepository;
        ...
        private bool IsVendorWarehouseOpen(Vendor vendor)
        {
            ...
            WarehouseScheduleMapping todaySchedule = GetTodayScheduleByVendorId(vendor.Id, baseUtcOffset);
        ...
        private WarehouseScheduleMapping GetTodayScheduleByVendorId(int vendorId, TimeSpan baseUtcOffset)
        {
            ...
            if (vendorWarehouseMapping is null) return null;
            IList<WarehouseScheduleMapping> warehouseSchedule = _warehouseScheduleService.GetWarehouseSchedule(vendorWarehouseMapping.WarehouseId);
            if (warehouseSchedule.Count == 0) return null;
            return warehouseSchedule.FirstOrDefault(mapping => mapping.DayId == (int)DateTime.UtcNow.AddHours(baseUtcOffset.TotalHours).DayOfWeek
                                                               && mapping.IsActive);
        }
        ...
        {
            var closestStores = GetClosestStores(latitud, longitud);
            int nearYouMaxStores = GetNearYouMaxStores();
        ...
        private int GetNearYouMaxStores()
        {
            var settings = _settingService.LoadSetting<DeliveryAppBackendConfigurationSettings>();

            return settings?.NearYouMaxStores > 0 ? settings.NearYouMaxStores : DefaultNearYouMaxStores;
        }
        ...
        public VendorInfo GetVendorInfo(int vendorId)
        {
            ...
            IList<VendorWarehouseInfo> foundWarehouseSchedules = _warehouseScheduleService
                .GetWarehouseSchedule(vendorWareHouseId)
                ...
                }).OrderByDescending(order => order.DayId).ToList();
