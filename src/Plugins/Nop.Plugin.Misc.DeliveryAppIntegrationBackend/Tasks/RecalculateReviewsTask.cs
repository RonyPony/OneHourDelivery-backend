            ...
            { 
                ...
                foreach (CustomerRatingModel ratingModel in ratings)
                {
                    var CustomerGenericAttribute = _genericAttributeService
                                                   ...
                                                   .FirstOrDefault(generic => generic.Key == NopCustomerDefaults.CustomCustomerAttributes);
                    ...
                    if (CustomerGenericAttribute is null)
                    {
                        ...
                        if (customer != null)
                        _genericAttributeService.SaveAttribute(customer, NopCustomerDefaults.CustomCustomerAttributes, customerAttributeList.ToXML());  
                    }
                    else
                    {
