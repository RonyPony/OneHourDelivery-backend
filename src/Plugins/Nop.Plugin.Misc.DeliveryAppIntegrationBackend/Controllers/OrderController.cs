...
namespace Nop.Plugin.Misc.DeliveryAppIntegrationBackend.Controllers
{
    ...
    public sealed class OrderController : Controller
    {
        ...
        private void SavePaymentMethodCheckoutAttribute(Delta<OrderDto> orderDelta, Customer customer)
        {
            ...
            _genericAttributeService.SaveAttribute(customer, NopCustomerDefaults.CheckoutAttributes, checkoutAttributes, _storeContext.CurrentStore.Id);
        ...
        public IActionResult OnOrderPaidByCyberSource([FromQuery] int orderId)
        {
            ...
            (_orderProcessingService as CustomOrderProcessingService).SendNotificationsAndSaveNotes(order);
