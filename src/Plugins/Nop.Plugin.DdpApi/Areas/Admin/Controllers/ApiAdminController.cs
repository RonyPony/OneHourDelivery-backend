...
namespace Nop.Plugin.DdpApi.Areas.Admin.Controllers
{
    [AuthorizeAdmin]
    ...
    public class ApiAdminController : BasePluginController
    {
        ...
        public IActionResult Settings()
        {
            ...
            return View($"~/Plugins/Nop.Plugin.DdpApi/Areas/Admin/Views/ApiAdmin/Settings.cshtml", model);
        }
        ...
        public IActionResult Settings(ConfigurationModel model)
        {
            ...
            * and loaded from database after each update */
            ...
            _customerActivityService.InsertActivity("EditApiSettings", "Edit DdpApi Settings");
