...
using Nop.Plugin.DdpApi.Delta;
using Nop.Plugin.DdpApi.DTO.Errors;
...
using Nop.Plugin.DdpApi.JSON.ActionResults;
using Nop.Plugin.DdpApi.JSON.Serializers;
using Nop.Plugin.DdpApi.ModelBinders;
using Nop.Plugin.DdpApi.Models.ProductsParameters;
...
namespace Nop.Plugin.DdpApi.Controllers
{
    [ApiController]
    public class ProductsController : BaseApiController
    {
        ...
        [HttpGet("/api/products"), Authorize(Roles = "Api Users", AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        ...
        /// <response code="200">OK</response>
        /// <response code="401">Unauthorized</response>
        [HttpGet("/api/products/count"), Authorize(Roles = "Api Users", AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        ...
        /// <response code="401">Unauthorized</response>
        [HttpGet("/api/products/{id}"), Authorize(Roles = "Api Users", AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        [ProducesResponseType(typeof(ProductsRootObjectDto), (int)HttpStatusCode.OK)]
        [ProducesResponseType(typeof(string), (int)HttpStatusCode.Unauthorized)]
        [ProducesResponseType(typeof(ErrorsRootObject), (int)HttpStatusCode.BadRequest)]
        ...
        [HttpPost("/api/products"), Authorize(Roles = "Api Users", AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        [ProducesResponseType(typeof(ProductsRootObjectDto), (int)HttpStatusCode.OK)]
        [ProducesResponseType(typeof(string), (int)HttpStatusCode.Unauthorized)]
        ...
        public IActionResult CreateProduct([ModelBinder(typeof(JsonModelBinder<ProductDto>))] Delta<ProductDto> productDelta)
        {
            ...
            productDelta.Dto.Merge(ref product);
        ...
        [HttpPut("/api/products/{id}"), Authorize(Roles = "Api Users", AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        [ProducesResponseType(typeof(ProductsRootObjectDto), (int)HttpStatusCode.OK)]
        [ProducesResponseType(typeof(string), (int)HttpStatusCode.Unauthorized)]
        [ProducesResponseType(typeof(string), (int)HttpStatusCode.NotFound)]
        [ProducesResponseType(typeof(ErrorsRootObject), 422)]
        ...
        [HttpPost("/api/UpdateExistProduct"), Authorize(Roles = "Api Users", AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        [ProducesResponseType(typeof(ProductsRootObjectDto), (int)HttpStatusCode.OK)]
        [ProducesResponseType(typeof(string), (int)HttpStatusCode.Unauthorized)]
        [ProducesResponseType(typeof(string), (int)HttpStatusCode.NotFound)]
        [ProducesResponseType(typeof(ErrorsRootObject), 422)]
        [ProducesResponseType(typeof(ErrorsRootObject), (int)HttpStatusCode.BadRequest)]
        public IActionResult UpdateExistProduct([ModelBinder(typeof(JsonModelBinder<ProductDto>))] Delta<ProductDto> productDelta)
        {
            // Here we display the errors if the validation has failed at some point.
            if (!ModelState.IsValid)
            {
        ...
        [HttpDelete("/api/products/{id}"), Authorize(Roles = "Api Users", AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
