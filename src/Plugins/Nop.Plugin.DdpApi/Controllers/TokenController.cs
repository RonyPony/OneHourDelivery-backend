...
using Nop.Plugin.DdpApi.Configuration;
using Nop.Plugin.DdpApi.Domain;
using Nop.Plugin.DdpApi.Infrastructure;
using Nop.Plugin.DdpApi.Models.Authentication;
    ...
    public class TokenController : Controller
    {
        ...
        private Customer ValidateUser(TokenRequest model)
        {
            ...
            if (result == CustomerLoginResults.Successful)
            {
                ...
                //activity log
                _customerActivityService.InsertActivity(customer, "DdpApi.TokenRequest", "User API token request", customer);
