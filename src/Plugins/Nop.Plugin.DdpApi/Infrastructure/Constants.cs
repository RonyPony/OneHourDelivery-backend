...
namespace Nop.Plugin.DdpApi.Infrastructure
{
    public static class Constants
    {
        public static class Roles
        {
            ...
            public const string ApiRoleName = "DdpApi Users";
        }

        public static class ViewNames
        {
            public const string AdminLayout = "_AdminLayout";
            public const string AdminApiSettings = "~/Plugins/Nop.Plugin.DdpApi/Views/Settings.cshtml";
            public const string AdminApiClientsCreateOrUpdate = "~/Plugins/Nop.Plugin.DdpApi/Views/Clients/CreateOrUpdate.cshtml";
            public const string AdminApiClientsSettings = "~/Plugins/Nop.Plugin.DdpApi/Views/Clients/ClientSettings.cshtml";
            public const string AdminApiClientsList = "~/Plugins/Nop.Plugin.DdpApi/Views/Clients/List.cshtml";
            public const string AdminApiClientsCreate = "~/Plugins/Nop.Plugin.DdpApi/Views/Clients/Create.cshtml";
            public const string AdminApiClientsEdit = "~/Plugins/Nop.Plugin.DdpApi/Views/Clients/Edit.cshtml";
        }

        public static class Configurations
        {
            public const int DefaultAccessTokenExpirationInDays = 3; // 3 days
