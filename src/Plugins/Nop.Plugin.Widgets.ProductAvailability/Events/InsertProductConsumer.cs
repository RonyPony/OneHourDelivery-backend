...
{
    /// <summary>
    /// Represents a consumer for <see cref="EntityInsertedEvent{Product}"/>.
    /// </summary>
    public sealed class InsertProductConsumer : IConsumer<EntityInsertedEvent<Product>>
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="InsertProductConsumer" />.
        /// </summary>
        ...
        /// <summary>
        /// Executes when the <see cref="EntityInsertedEvent{Product}"/> is fired.
        /// <param name="eventMessage">An instance of <see cref="EntityInsertedEvent{Product}"/>.</param>
