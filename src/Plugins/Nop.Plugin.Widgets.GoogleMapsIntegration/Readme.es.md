...
Este complemento fue desarrollado con el fin de integrar NopCommerce (versión 4.30) con Google Maps Platform, permitiendo que las direcciones de NopCommerce administren coordenadas geográficas y permitiendo al usuario acceder a algunos de los servicios más útiles de Google Maps.
