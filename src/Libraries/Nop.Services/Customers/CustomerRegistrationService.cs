...
namespace Nop.Services.Customers
{
    ...
    public partial class CustomerRegistrationService : ICustomerRegistrationService
    {
        ...
        /// <summary>
        /// Check whether the entered password matches with a saved one hashed
        /// </summary>
        /// <param name="customerPassword">Customer password</param>
        /// <param name="enteredPassword">The entered password</param>
        /// <returns>True if passwords match; otherwise false</returns>
        protected bool PasswordsMatchWithOldPasswordHashed(CustomerPassword customerPassword, string enteredPassword)
        {
            if (customerPassword == null || string.IsNullOrEmpty(enteredPassword))
                return false;
            ...
            return customerPassword.Password.Equals(enteredPassword);
        }
        ...
        /// <summary>
        /// Change password with old password hashed
        /// </summary>
        /// <param name="request">Request</param>
        /// <returns>Result</returns>
        public virtual ChangePasswordResult ChangePasswordWithOldPasswordHashed(ChangePasswordRequest request)
        {
            if (request == null)
                throw new ArgumentNullException(nameof(request));
            ...
            //request isn't valid
            if (request.ValidateRequest && !PasswordsMatchWithOldPasswordHashed(_customerService.GetCurrentPassword(customer.Id), request.OldPassword))
            {
                result.AddError(_localizationService.GetResource("Account.ChangePassword.Errors.OldPasswordDoesntMatch"));
                return result;
            }
