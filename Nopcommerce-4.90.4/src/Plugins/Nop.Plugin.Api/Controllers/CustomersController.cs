...
namespace Nop.Plugin.Api.Controllers
{
    ...
    public class CustomersController : BaseApiController
    {
        ...
        public async Task<IActionResult> CreateCustomer([ModelBinder(typeof(JsonModelBinder<CustomerDto>))] Delta<CustomerDto> customerDelta)
        {
            ...
            {
                _genericAttributeService.SaveAttribute(newCustomer, "LanguageId", languageId);
            }
        ...
        public async Task<IActionResult> UpdateCustomer([ModelBinder(typeof(JsonModelBinder<CustomerDto>))] Delta<CustomerDto> customerDelta)
        {
            ...
            if (!string.IsNullOrEmpty(customerDelta.Dto.LanguageId) && int.TryParse(customerDelta.Dto.LanguageId, out var languageId)
                                                                    && _languageService.GetLanguageById(languageId) != null)
            {
                _genericAttributeService.SaveAttribute(currentCustomer, "LanguageId", languageId);
            }
        ...
        private void InsertFirstAndLastNameGenericAttributes(string firstName, string lastName, Customer newCustomer)
        {
            ...
            if (firstName != null)
            {
                _genericAttributeService.SaveAttribute(newCustomer, "FirstName", firstName);
            }

            if (lastName != null)
            {
                _genericAttributeService.SaveAttribute(newCustomer, "LastName", lastName);
            }
        }
