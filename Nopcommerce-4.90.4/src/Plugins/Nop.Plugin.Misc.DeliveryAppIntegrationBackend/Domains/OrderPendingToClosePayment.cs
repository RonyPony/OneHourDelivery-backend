...
{
    /// <summary>
    /// Represents an order pending to close payment
    /// </summary>
    public partial class OrderPendingToClosePayment : BaseEntity
    {
        #region Properties
        ...
        /// <summary>
        /// Gets or sets the vendor payment status identifier
        /// </summary>
        public int VendorPaymentStatusId { get; set; }

        /// <summary>
        /// Gets or sets the Driver payment status identifier
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the Vendor payment status
        /// </summary>
        public PaymentStatus DriverPaymentStatus
        {
            get => (PaymentStatus)DriverPaymentStatusId;
            set => DriverPaymentStatusId = (int)value;
        }

        /// <summary>
        /// Gets or sets the Vendor payment status
        /// </summary>
        public PaymentStatus VendorPaymentStatus
        {
            get => (PaymentStatus)VendorPaymentStatusId;
            set => VendorPaymentStatusId = (int)value;
        }
