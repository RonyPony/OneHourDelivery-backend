    ...
    public class ClientController : Controller
    {
        ...
        public IActionResult CreateClient([FromBody] RegisterCustomerRequest request)
        {
            ...
            try
            {
                ...
                _workflowMessageService.SendCustomerEmailValidationMessage(customer, _workContext.GetWorkingLanguageAsync().GetAwaiter().GetResult().Id);
        ...
        public async Task<IActionResult> UpdateCustomer(int id, [FromBody] UpdateCustomerRequest request)
        {
            ...
            {
                await _logger.ErrorAsync($"There was error updating customer. {ex.Message}", ex);
                return BadRequest(new { message = ex.Message });
            }
        }
        ...
        public IActionResult GetCustomerData(int customerId)
        {
            try
            {
                ...
                var customerData = new CustomerData(id: customerId,
                    firstName: _genericAttributeService.GetAttribute<string>(currentCustomer, "FirstName"),
                    lastName: _genericAttributeService.GetAttribute<string>(currentCustomer, "LastName"),
                    email: currentCustomer.Email,
                    phoneNumber: _genericAttributeService.GetAttribute<string>(currentCustomer, "Phone"),
